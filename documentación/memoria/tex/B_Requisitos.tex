...
\begin{table}[H]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\textbf{Postcondición}        &
   		\begin{itemize}
  			\item Usuario autenticado en el sistema.
			  \item Sesión activa creada.
                \item Redirección según rol de usuario.
  		\end{itemize} \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\textbf{Postcondición}        &
   		\begin{itemize}
  			\item Nueva cuenta de usuario creada.
			  \item Email de confirmación enviado.
  		\end{itemize} \\
		\textbf{Excepciones}          &  Error de conexión a base de datos. El sistema muestra mensaje de error técnico de modo que el usuario puede reintentar más tarde.\\
		\textbf{Importancia}          & Alta \\
		\textbf{Casos de Prueba}      &
